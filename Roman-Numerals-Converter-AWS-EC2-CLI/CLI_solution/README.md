...
```bash
aws ec2 run-instances --image-id ami-00874d747dde814fa --count 1 --instance-type t2.micro --key-name firstkey --security-groups ssh --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=ssh}]' --user-data file:///home/ec2-user/userdata.sh
or
